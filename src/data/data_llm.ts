...
export const OWASP_TOP_10_DATA: OwaspTop10Entry[] = [
  ...
  },
  {
    ...
    suggestedTools: [
      ...
      { name: "Burp Suite", description: "Web security testing for XSS, injection, and unsafe rendering paths.", url: "https://portswigger.net/", cost: "Free tier / $449/yr (Pro)", type: "Third-party" }
    ]
  }
];
