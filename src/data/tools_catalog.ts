...
const PROMPT_INJECTION_TOOLS: SecurityTool[] = [
  ...
  { name: "Protect AI Guardian", description: "Secure LLM gateway enforcing security policies against prompt injection and PII leakage.", url: "https://protectai.com/", cost: "Free OSS / ~$1,000/mo (Team)", type: "Third-party", category: "Defensive" },
  { name: "Aporia AI Guardrails", description: "Real-time guardrail proxy with sub-10ms latency for hallucinations and jailbreaks.", url: "https://github.com/aporia-ai", cost: "Free tier / $0.001/req", type: "Third-party", category: "Defensive" },
  { name: "CalypsoAI", description: "Enterprise AI security platform providing scanner and real-time LLM input/output policy enforcement.", url: "https://github.com/CalypsoAI", cost: "~$15k - $40k/yr (Enterprise)", type: "Third-party", category: "Defensive" },
  { name: "Arthur Shield", description: "Real-time firewall for LLMs detecting prompt injections and toxic outputs.", url: "https://www.arthur.ai/", cost: "Free trial / ~$1,000/mo", type: "Third-party", category: "Defensive" },
...
const SENSITIVE_DATA_TOOLS: SecurityTool[] = [
  ...
  { name: "Diffprivlib", description: "IBM library for differential privacy in machine learning models and data pipelines.", url: "https://github.com/IBM/differential-privacy-library", cost: "Free", type: "Local", category: "Defensive" },
...
const MISINFORMATION_TOOLS: SecurityTool[] = [
  ...
  { name: "Fiddler AI", description: "Pre-deployment LLM vulnerability scanner (Auditor) and real-time inference guardrails.", url: "https://www.fiddler.ai/", cost: "~$20k - $50k/yr (Enterprise)", type: "Third-party", category: "Both" },
  { name: "Aporia AI Guardrails", description: "Real-time guardrail proxy with sub-10ms latency for hallucinations and jailbreaks.", url: "https://github.com/aporia-ai", cost: "Free tier / $0.001/req", type: "Third-party", category: "Defensive" },
  ...
  { name: "MarkLLM", description: "Toolkit for watermarking Large Language Models and watermark detection testing.", url: "https://arxiv.org/abs/2405.10051", cost: "Free", type: "Local", category: "Both" },
...
const INPUT_MANIPULATION_TOOLS: SecurityTool[] = [
  ...
  { name: "SecML", description: "Python library for security evaluation and adversarial attacks on machine learning algorithms.", url: "https://github.com/pralab/secml", cost: "Free", type: "Local", category: "Offensive" },
  { name: "Robust Intelligence", description: "Automated AI red teaming, continuous risk validation, and runtime AI firewall.", url: "https://github.com/robustintelligence", cost: "~$30k - $75k/yr (Enterprise)", type: "Third-party", category: "Both" },
