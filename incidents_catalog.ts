...
export const INCIDENTS_BY_THREAT_ID: Record<string, ExternalResource[]> = {
  ...
  "LLM09:2026": INDIRECT_PROMPT_INJECTION_INCIDENTS,
  ...
  "AST05": INDIRECT_PROMPT_INJECTION_INCIDENTS,
  "AST06": COMMAND_EXECUTION_INCIDENTS,
  "AST07": SUPPLY_CHAIN_INCIDENTS,
  "AST08": INDIRECT_PROMPT_INJECTION_INCIDENTS,
